  ...
  <!--============================== content =================================-->      
   <div id="content"><div class="ic">More Website Templates @ TemplateMonster.com. November19, 2012!</div>
    <div class="container">
        ...
        <article class="span8">
         <div class="inner-1">  
         <br><br><center><h3>Forum</h3></center><br><br>
         <p align="center"> <?php
		 session_start();
...
<?php
if(empty($_SESSION['prenom'])){ ?>
		<strong>Bonjour, vous n'etes actuellement pas connecté </strong>:<a href="con_forum.php">connexion</a> <a href="inscription.php">Inscription</a>
<?php } ?>
...
if ($nb_sujets == 0) {
	...
	?>
	<table class="categories_table" width="100%"><tr>
	<th class="title">
	  <strong>Auteur</strong></th><th>
	    <strong>Sujet</strong></th><th>
	      <strong>Date</strong></th></tr>
	<?php
	...
	echo '<font color="red" face="mr-bedfort"><a href="./lire_sujet.php?id_sujet_a_lire=' , $data['id'] , '" title="cliquer"> ' , htmlentities(trim($data['titre'])) , '</a></font>';
...
if(!empty($_SESSION['prenom'])){ ?>
        ...
        <div class="center"> <font face="Bradley Hand ITC" size="4" color="#FFFFFF"><strong> <a href="./insert_sujet.php" title="vous pouvez inserer votre sujet en cliquant sur ce lien">Insérer un sujet</a></strong></font>
<?php } ?>
	    </div>
