  ...
  <!--============================== content =================================-->      
   <div id="content"><div class="ic">More Website Templates @ TemplateMonster.com. November19, 2012!</div>
    <div class="container">
      ...
      <article class="span8">
        <div class="inner-1">
        <h3> Inscription au forum</h3>         <p>&nbsp;</p>
         <p>
...
Nom </td>
<td style="width:50%">
<input type="text" name="nom" maxlength="20" id="nom" style="
    width: 410px;
    height: 37px;
...
Prénom </td>
<td>
<input type="text" name="prenom" maxlength="20" id="prenom" style="
    width: 410px;
    height: 37px;
" ><span style="color:red"> *</span>
</td>
...
<input type="text" name="email" maxlength="35" id="email" style="
    width: 410px;
    height: 37px;
"><span style="color:red"> *</span>
</td>
...
<td>
<input type="password" name="pass" maxlength="15" id="pass" style="
    width: 410px;
    height: 37px;
"><span style="color:red">* (6-15 caractères)</span>
</td>
</tr>
...
<div style="float:right;margin-right:22.8%;">
<input type="submit" value="s'inscrir" class="btn btn-1">
<input type="reset" value="effacer"class="btn btn-1">
