...
<h1 class="brand brand_"><a href="#"><img src="img/logo.gif" alt="liberta" title="Radio Liberta" onClick="popup()"></a></h1>            <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse_">Menu <span class="icon-bar"></span> </a>
            <div class="nav-collapse nav-collapse_  collapse">
               ...
               <li class="sub-menu"><a href="#">Loisir  الترفيه</a>
                 ...
                 <li class="active"><a href="contacte.php">Contact اتصل بنا</a></li>
              </ul></div>
          </div>
            </div>
      </div>
...
<div class="bg-content"><!--============================== content =================================-->
    ...
    <div class="container">
        ...
        <article class="span8">
              ...
              <div class="inner-1">
              <br><br><br><br>
            <form name="f" method="post" action="ajout_contacte.php">
             <div class="success"> </strong> </div>
                  <fieldset>
                <div>
                    <label class="name">
                    <input type="text" value="nom" name="nom" required style="
    width: 410px;
    height: 37px;
">
                  <br>
                  ...
                  <div>
                    <label class="phone">
                    <input type="tel" value="Telephone" name="tel" required style="
    width: 410px;
    height: 37px;
">
                    <br>
                ...
                <div>
                    <label class="email">
                    <input type="email" value="Email" name="mail" required style="
    width: 410px;
    height: 37px;
">
                    <br>
                ...
                <div>
                    <label class="message">
                      <textarea name="msg" rows="10" style=" width: 410px;">Message</textarea>
                      <br>
                    </label>
                    </div>
               ...
               <center><input type="submit" class="btn btn-1" onClick="alert("votre message a ete envoyer")"> <input type="reset" class="btn btn-1"></center>
              </fieldset>
                </form>
          </div>
            </article>
        <article class="span4">
              <h3>Contact info</h3>
              <div class="map">
            <iframe src="https://maps.google.com/maps?ll=40.664592,-73.946975&z=14&t=m&hl=fr-FR&gl=US&mapclient=embed&skstate=action:mps_dialog%24apiref:1&output=classic"> </iframe>
          </div>
