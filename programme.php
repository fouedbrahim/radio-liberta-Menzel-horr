...
<h1 class="brand brand_"><a href="#"><img src="img/logo.gif" alt="liberta" title="Radio Liberta" onClick="popup()"></a></h1>            <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse_">Menu <span class="icon-bar"></span> </a>
            <div class="nav-collapse nav-collapse_  collapse">
                ...
                <li  class="active"><a href="#">Radio    الراديو</a>
                      <ul>
...
<div class="bg-content"> 
    ...
    <div class="container">
        ...
        <ul class="thumbnails thumbnails-1 list-services">
         <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='lundi';";
            ...
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>LUNDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
          <?php
			...
			?>
              <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='mardi';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>MARDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
         <?php
            ...
            <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='mercredi';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>MERCREDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
         <?php
            ...
            <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='jeudi';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>JEUDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
         <?php
            ...
            <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='vendredi';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>VENDREDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
         <?php
            ...
            <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='samedi';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>SAMEDI</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
         <?php
            ...
            <?php
			include('config.php');
			$req="SELECT * FROM `programme` where  jour='dimanche';";
			...
			?>
              <li class="span4">
            <div class="thumbnail thumbnail-1">
              <section> <span class="label-warning"><strong>DIMANCHE</strong></span>
  <p>* <?php echo $ligne[1] ?> <BR>* <?php echo $ligne[2] ?> <BR>* <?php echo $ligne[3] ?> <BR>* <?php echo $ligne[4] ?></p>
            </section>
                </div>
          </li>
