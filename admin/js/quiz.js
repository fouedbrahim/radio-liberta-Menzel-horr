...
// answer was wrong and give addional historial info.
	var correct_explanation  = new Array('la reponse correcte est : le 4 ferier','la reponse correcte est :le radon','la reponse correcte est :le cancer du col','la reponse correcte est :le depister tot','la reponse correcte est :Que les cellules se multiplient de façon exageree','la reponse correcte est : Le virus de la grippe','la reponse correcte est : Leucemie','la reponse correcte est : Le tabagisme et lalcool ','la reponse correcte est : 35 %'
...
// that will color it gree and it will add the 'Correct' word next to it.
			for(var i = 0; i < answers.length; i++){
				if(answers[i] == correct_answers[i]){
					...
					elements[i].innerHTML += ' Bravo !! Correcte!';  
...
// out of all questions.
			quiz_results.innerHTML = 'vous avez  ' + correct_answers_chosen + ' reponses correcte  sur  ' + correct_answers.length+ ' questions';
