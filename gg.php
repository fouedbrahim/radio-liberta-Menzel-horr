...
<header>
    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
			...
			{
			?>
            <h1 class="brand brand_"><a href="<?php echo $ligne[0] ?>" target="_blank"><img alt="liberta" src="img/logo.gif" title="Radio Liberta"> </a></h1>
            <?php
			}
			?>
    ...
    <div class="row-1">
        ...
        <div class="row">
            ...
            <li class="span3">
                ...
                <h3>Photos liberta Sport</h3>
                <img  src="img/page1-img1.jpg" alt="">
                <section> 
                    
                   <center>   <a href="gallerie1.php" class="btn btn-1" >Photos Liberta Sport !  </a> </center></section>
              </div>
                </li>
            <li class="span3">
                  <div class="thumbnail thumbnail-1">
                <h3>Photos liberta Culture !</h3>
                <img  src="img/page1-img2.jpg" alt="">
                <section><center>   <a href="gallerie2.php" class="btn btn-1" >Photos Liberta Culture !  </a> </center> </section>
              </div>
                </li>
            <li class="span3">
                  <div class="thumbnail thumbnail-1">
                <h3>Photos liberta Iterviews</h3>
                <img  src="img/page1-img3.jpg" alt="">
                <section> <center>   <a href="gallerie3.php" class="btn btn-1" >Photos Liberta Interviews !  </a> </center> </section>
              </div>
                </li>
            <li class="span3">
                  <div class="thumbnail thumbnail-1">
                <h3 class="title-1 extra">Photos liberta Emissions</h3>
                <img  src="img/page1-img4.jpg" alt="">
                <section><center>   <a href="gallerie4.php" class="btn btn-1" >Photos Liberta Emissions !  </a> </center> </section>
              </div>
                </li>
          </ul>
            </div>
