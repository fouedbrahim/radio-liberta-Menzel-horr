  ...
  <!--============================== content =================================-->      
   <div id="content"><div class="ic">More Website Templates @ TemplateMonster.com. November19, 2012!</div>
    <div class="container">
         ...
         <?php
			include('config.php');
			$req="SELECT * FROM `videos` where type='emission';";
			$resultat=mysql_query($req);
         ...
         <ul class="thumbnails thumbnails-1 list-services">
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <iframe width="90%"  height='180px' src="<?php echo $ligne[0] ?> " frameborder="3" allowfullscreen frameborder="1"></iframe>
                  <section> 
               <p class="text-error"><a href="<?php echo $ligne[0] ?>" target="_blank"><?php echo $ligne[1] ?></a></p>
              </section>
                </div>
          </li>
