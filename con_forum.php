   ...
   <div id="content"><div class="ic">More Website Templates @ TemplateMonster.com. November19, 2012!</div>
    <div class="container">
        ...
        <article class="span8">
         <div class="inner-1">
       <h3>  Connexion</h3>
           <section id="auth_membre" style="font-size:20px;font-family:Verdana;float:right;">                  
                              <?php
						
                       
                         session_start();
if(!empty($_SESSION['prenom'])){ ?>
	<br><br><p align="center"> <font face="Bradley Hand ITC" size="4"><B>Bonjour ,<?php echo($_SESSION['nom']."&nbsp".$_SESSION['prenom'])?></B><a href="logout.php">   Déconnexion</a></font></p>				
...
if(empty($_SESSION['prenom'])){ ?>	 
	...
	<tr><td></td><td align="center"><input type="submit" value="connexion" class="btn btn-1"/>
    <input type="reset" value="annuler" class="btn btn-1"/></td></tr></table></p>
