...
<html lang="en">
	<head>
	<title>Photos evennements</title>
	<meta charset="utf-8">
...
<div class="bg-content">       
  <!--============================== content =================================-->      
    ...
    <div class="container">
        ...
        <h3>Liberta photos (evennements)...</h3>
         </article>
		 
        <div class="clear"></div>
         <ul class="portfolio clearfix"><?php
			include('config.php');
			$req="SELECT * FROM `gallerie` where type ='evennement';";
			$resultat=mysql_query($req);
			
			while($ligne=(mysql_fetch_row($resultat)))
			{
			?>           
          <li class="box"><a href="admin/photo/<?php echo $ligne[1] ?> " class="magnifier"><img alt="" src="admin/photo/<?php echo $ligne[1] ?>"  style="
    width: 200px;
"></a> <br> 
           <strong><?php echo $ligne[2] ?></strong></li> 
