   ...
   <div id="content"><div class="ic">More Website Templates @ TemplateMonster.com. November19, 2012!</div>
    <div class="container">
      ...
      <form>   
         <?php
			include('config.php');
			$req="SELECT * FROM `articles blog` where  type='sport';";
...
> 
  ...
  <tr>
    <td width="77%" rowspan="2"> Titre : <?php echo $ligne[2] ?><br><br>
   <strong> <?php echo $ligne[1] ?> </strong>
    
   
    <section align="center"><em> auteur : <?php echo $ligne[3] ?></em>,  date : <?php echo $ligne[4] ?> </section> <a name="fb_share" type="button" expr:share_url='data:post.url' href="http://www.facebook.com/sharer.php">Partager</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script><br><center><input id="impression" name="impression" type="button" onclick="imprimer_page()" value="Imprimer cette page" class="btn-1" /></center></td>
